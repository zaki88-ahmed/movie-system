...
<html lang="en">
	<head>
		...
		<title>Movie-System20020 - @yield('title')</title>
				...
				<div id="bottom-footer" class="row">
					...
					<div class="col-md-8 col-md-pull-4">
						<div class="footer-copyright">
							<span>&copy; Copyright 2021. All Rights Reserved. | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#">Movie-System</a></span>
						</div>
					</div>
					<!-- /copyright -->
